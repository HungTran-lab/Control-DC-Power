...
# Timer for blinking RUN
    ...
    def reset_output_ui(self):
        ...
        for lb in (self.status_18, self.status_21, self.status_25):
            if lb is not None:
                lb.setText("STOP")
                lb.setStyleSheet("")
    ...
    def set_stick(self, value):
        ...
        try:
            if value == 18:
                ...
                self.psw.set_vi(21.0, 30.0)
                self.log("VS21: Set 21.0V / 30.0A")
                ...
                self.psw.set_vi(25.2, 45.0)
                self.log("VS25: Set 25.2V / 45.0A")
                ...
                self.log(f"Unknown preset: {value}")
                return
        except Exception as e:
            self.handle_connection_lost(e)
            return
